...
set JAVA_HOME="C:\Program Files (x86)\Java\jre7\bin\java"
...
call "C:\Program Files (x86)\Java\jre7\bin\java" -classpath %JAVA_CP% com.bgba.osbjarexporter.OsbJarExporter %1 %2 mi.jar >> %ArchivoLog%
:: ---------------------------------------------------------------
:salida